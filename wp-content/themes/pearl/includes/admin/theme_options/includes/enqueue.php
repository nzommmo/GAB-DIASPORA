...
function pearl_admin_to_styles( $hook ) {
	...
	wp_enqueue_style( 'mdcolorpicker-css', get_template_directory_uri() . '/includes/admin/theme_options/includes/src/md-color-picker/dist/mdcolorpicker.min.css', null, $theme_info['v'] );


	wp_enqueue_script( 'stm_theme_options_vendors', $theme_info['to_vendor'] . 'vendor.js', null, $theme_info['v'], 'all' );
	wp_enqueue_script( 'pearl_theme_options_tinycolor', get_template_directory_uri() . '/includes/admin/theme_options/includes/src/tinycolor/tinycolor.js', null, $theme_info['v'], true );
	wp_enqueue_script( 'pearl_theme_options_mdcolorpicker', get_template_directory_uri() . '/includes/admin/theme_options/includes/src/md-color-picker/dist/mdcolorpicker.min.js', null, $theme_info['v'], true );
