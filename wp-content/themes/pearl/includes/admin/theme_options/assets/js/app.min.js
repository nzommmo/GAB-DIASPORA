...
var theme_options = angular.module('theme_options', ['app.components', 'app.directives', 'app.services', 'app.config', 'app.filters']).run(function ($rootScope) {
...
theme_options.run(_run.appRun).constant('siteBreakpoints', _constants.siteBreakpoints);

angular.module('app.components', ['ngMaterial', 'ngRoute', 'ui.bootstrap', 'mdColorPicker', 'dndLists', 'infinite-scroll', 'colorpicker.module', 'ui.sortable']);
